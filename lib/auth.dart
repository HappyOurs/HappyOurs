...
class LoginMethodUnknown implements Exception {
  List<String> possibleLoginMethods;
...
abstract class BaseAuth {
  ...
  Future<User?> signInWithOTP({required String otpCode});
...
class Auth implements BaseAuth {
  ...
  Future<List<String>> _emailLoginMethods({required String email}) async {
...
//              background: Color(0xff29a39d));
  ...
  Future<User?> signInWithOTP({required String otpCode}) async {
    if (otpCode.length != 6) {
